import { fetchPrivacyPolicy } from "@/utils/privacy-policy.service";
...
export default async function PrivacyPolicy() {
  ...
  return (
    <div className="px-6 md:px-14 py-12 container mx-auto">
      <Link
        href="/"
        ...
        <section className="space-y-8">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[15px]">Address: {data.contactInfo.address}</p>
            </div>
          </div>
        </section>
      </div>
